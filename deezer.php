...
{
    $_SESSION['deezer']= $_POST ['deezer'];
    $sql = $cnnPDO->prepare("UPDATE streaming SET deezer =:deezer WHERE email =:email");
    $sql->bindParam(':email', $_SESSION['email']);
    $sql->bindParam(':deezer', $_SESSION['deezer']);
    $sql->execute();
    unset($sql);
    unset($cnnPDO);
    }
...
<body>
    ...
    <form method="post">
        <div style="width:350px;margin: auto; margin-top: 60px;">
        <center><img src="img/zeer.png" width="220px" >  
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                    <input type="text" readonly class="form-control-plaintext" id="staticEmail" value="            Deezer">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="staticEmail" class="col-sm-2 col-form-label">Precio:</label>
                    <div class="col-sm-10">
                    <input type="text" readonly class="form-control-plaintext" id="staticEmail" value="            $80MX">
                    </div>
                </div>
                    <h6>¿Desea Suscribirse a esta plataforma?</h6>
                    <input type="hidden" name="deezer" id="deezer" value="Suscrito">
