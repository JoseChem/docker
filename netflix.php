...
if (isset($_POST['continuar'])) {
    $_SESSION['netflix'] = $_POST['netflix'];
    $sql = $cnnPDO->prepare("UPDATE streaming SET netflix =:netflix WHERE email =:email");
    $sql->bindParam(':email', $_SESSION['email']);
    $sql->bindParam(':netflix', $_SESSION['netflix']);
    $sql->execute();
    unset($sql);
    unset($cnnPDO);
}
...
<body>
    ...
    <form method="post">
        <div style="width:350px;margin: auto; margin-top: 100px;">
            <center><img src="img/net.png" width="60px">
                <div class="mb-3 row">
                ...
                <input type="hidden" name="netflix" id="netflix" value="Suscrito">
                <center><button type="submit" class="btn btn-danger" style="width:150px" id="continuar"
                        name="continuar">Suscribirme</button></center>
                <br>
                <center><a href="index2.php"><button type="button" class="btn btn-info" name="volver">No,
                            Regresar</button></a></center>
