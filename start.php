...
if (isset($_POST['continuar']))  
{
    ...
    $sql = $cnnPDO->prepare("UPDATE streaming SET start =:start WHERE email =:email");
    $sql->bindParam(':email', $_SESSION['email']);
    $sql->bindParam(':start', $_SESSION['start']);
    $sql->execute();
    unset($sql);
    unset($cnnPDO);
    }
...
<body>
    ...
    <form method="post">
        ...
        <center><img src="img/start.png" width="180px" >    
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                    <input type="text" readonly class="form-control-plaintext" id="staticEmail" value="            Start+">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="staticEmail" class="col-sm-2 col-form-label">Precio:</label>
                    <div class="col-sm-10">
                    <input type="text" readonly class="form-control-plaintext" id="staticEmail" value="            $229MX">
                    </div>
                </div>
                <h6>¿Desea Suscribirse a esta plataforma?</h6>
                <input type="hidden" name="start" id="start" value="Suscrito">
