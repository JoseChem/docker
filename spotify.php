...
{
    $_SESSION['spotify']= $_POST ['spotify'];
    $sql = $cnnPDO->prepare("UPDATE streaming SET spotify =:spotify WHERE email =:email");
    $sql->bindParam(':email', $_SESSION['email']);
    $sql->bindParam(':spotify', $_SESSION['spotify']);
    $sql->execute();
    unset($sql);
    unset($cnnPDO);
    }
...
<body>
    ...
    <form method="post">
        ...
        <center><img src="img/spo.png" width="120px" >  
        <br>  
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                    <input type="text" readonly class="form-control-plaintext" id="staticEmail" value="            Spotify">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="staticEmail" class="col-sm-2 col-form-label">Precio:</label>
                    <div class="col-sm-10">
                    <input type="text" readonly class="form-control-plaintext" id="staticEmail" value="            $135MX">
                    </div>
                </div>
                    <h6>¿Desea Suscribirse a esta plataforma?</h6>
                    <input type="hidden" name="spotify" id="spotify" value="Suscrito">
