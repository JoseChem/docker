...
{
    $_SESSION['disney']= $_POST ['disney'];
    $sql = $cnnPDO->prepare("UPDATE streaming SET disney =:disney WHERE email =:email");
    $sql->bindParam(':email', $_SESSION['email']);
    $sql->bindParam(':disney', $_SESSION['disney']);
    $sql->execute();
    unset($sql);
    unset($cnnPDO);
    }
...
<body>
    ...
    <form method="post">
        ...
        <center><img src="img/dis.png" width="160px" >    
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                    <input type="text" readonly class="form-control-plaintext" id="staticEmail" value="            Disney">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="staticEmail" class="col-sm-2 col-form-label">Precio:</label>
                    <div class="col-sm-10">
                    <input type="text" readonly class="form-control-plaintext" id="staticEmail" value="            $159MX">
                    </div>
                </div>
                    <h6>¿Desea Suscribirse a esta plataforma?</h6>
                    <input type="hidden" name="disney" id="disney" value="Suscrito">
