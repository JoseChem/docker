			...
			<div class="col">
			  <div class="card h-100">
				...
				<div class="card-footer">
					<center><button type="button" class="btn btn-danger" name="netflix" id="suscribirme">Suscribirme</button></center>
				</div>
			  </div>
			</div>
			<div class="col">
				<div class="card h-100">
				  ...
				  <div class="card-footer">
				  <center><button type="button" class="btn btn-danger" name="netflix" id="suscribirme2">Suscribirme</button></center>
				  </div>
				</div>
			  </div>
			  <div class="col">
				<div class="card h-100">
				  ...
				  <div class="card-footer">
				  <center><button type="button" class="btn btn-danger" name="hbo" id="suscribirme3">Suscribirme</button></center>
				  </div>
				</div>
			  </div>
			  <div class="col">
				<div class="card h-100">
				  ...
				  <div class="card-footer">
				  <center><a href="start.php"><button type="button" class="btn btn-danger" name="netflix" id="suscribirme4">Suscribirme</button></a></center>
				  </div>
				</div>
			  </div>
			  <div class="col">
				<div class="card h-100">
				  ...
				  <div class="card-footer">
				  <center><a href="spotify.php"><button type="button" class="btn btn-danger" name="netflix" id="suscribirme5">Suscribirme</button></a></center>
				  </div>
				</div>
			  </div>
			  <div class="col">
				<div class="card h-100">
				  ...
				  <div class="card-footer">
				  <center><a href="deezer.php"><button type="button" class="btn btn-danger" name="netflix" id="suscribirme6">Suscribirme</button></a></center>
				  </div>
				</div>
			  </div>
		  </div>
...
$('#suscribirme').click(function(){
         Swal.fire({
            icon: 'danger',
				  ...
				  footer: '<a href="registrarme.php">Registrarme</a>',
				  timer: 4000
                });
        return false;
      });
	  $('#suscribirme2').click(function(){
         Swal.fire({
            icon: 'danger',
                  title: 'Inicia Sesion o Registrate',
                  showConfirmButton: true,
